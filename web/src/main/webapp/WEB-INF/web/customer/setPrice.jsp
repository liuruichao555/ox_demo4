...
<div>
    ...
    <div style="width: 300px;margin: 0 auto;">
        <input type="button" value="确认" id="setPriceBtn">
    </div>
</div>
<script src="/js/jquery-2.2.3.min.js"></script>
<script>
    $(function() {
        var recordId = '${requestScope.recordId}';
        $('#setPriceBtn').click(function() {
            ...
            $.ajax({
                url: '/customer/cusSetPrice',
                type: 'POST',
                data: {'id': recordId, 'price': price, 'dataItem': dataItems.join(',')},
                dataType: 'json',
                success: function (data) {
                    if (data.status == 1) {
                        alert('定价成功!' + data.message);
